...
accept x number prompt "Enter Team ID: " 
accept y char prompt "Enter Team Name: " 
accept z char prompt "Enter League: " 
...
BEGIN
	...
	select count(team_id) into num2 from hockey_team@site_link;
